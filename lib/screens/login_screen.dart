...
import 'package:blo_tracker/services/session_manager.dart';
...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  void _submitLogin() async {
    ...
    try {
      ...
      await prefs.setString('blo_user_id', user['userId']);

      // Save login state and user to local DB
      final appNotifier = ref.read(appStateProvider.notifier);
      await appNotifier.setLogin(token);
      await UserDatabaseService.insertUser(userModel);

      // Check tracking enforcement logic
...
//       print("❌ Login failed: $e");
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(content: Text("Login failed. Please retry")),
//       );
//     } finally {
//       setState(() => isLoading = false);
//     }
